...
public class BookingController {
	...
	@PostMapping("service")
	@Operation(summary = "Api to book service")
	...
	@Operation(summary = "Api to fetch all booked service")
	...
	@GetMapping("/fetch")
	@Operation(summary = "Api to fetch my booked ground")
	...
	@Operation(summary = "Api to fetch booking by booking id")
	...
	@Operation(summary = "Api to fetch all booking status")
	...
	@Operation(summary = "Api to update booking status")
	...
	@Operation(summary = "Api to update the service status")
	...
	@Operation(summary = "Api to fetch all service status")
	...
	@Operation(summary = "Api to fetch all payment mode")
